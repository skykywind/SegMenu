...
class SegMenuItem: UIView {
    ...
    func configure(for pageMenu: SegMenu, controller: UIViewController, index: CGFloat) {
        if pageMenu.configuration.useMenuAsSegmentedControl {
            //**************************拡張*************************************
        ...
        self.titleLabel!.textColor = pageMenu.configuration.unselectedMenuItemTextColor
        

        self.titleLabel!.adjustsFontSizeToFitWidth = pageMenu.configuration.autoAdjustFontWithItemWidth
